function create_router_block(world, ground, offsetx, offsety, part_index) {
	...
	var diverter_poly = new Polygon(translate_points([Vec2(0,0), Vec2(0.5, -0.5), Vec2(2.5,1.5), Vec2(2,2)], col*narrow_pitch, -col*y_pitch));
	addFixture(diverter, diverter_poly, mass_normal, collisions_toplayer);
	var outtake_poly = new Polygon(translate_points([Vec2(-2,0), Vec2(col*narrow_pitch+0.5, 0), Vec2(col*narrow_pitch+0.5,0.5), Vec2(0,0.5)], 0, -col*y_pitch-0.5));
